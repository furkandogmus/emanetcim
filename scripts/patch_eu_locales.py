...
DE_GUEST = {
    ...
    "payBookingSubtitle": "Nutzen Sie oben einen Wallet-Button, falls angezeigt, oder bezahlen Sie unten mit Karte — sicherer Checkout.",
...
FR_GUEST.update(
    {
        ...
        "payBookingSubtitle": "Utilisez un portefeuille en haut s’il apparaît, ou votre carte en bas — paiement sécurisé.",
...
ES_GUEST = {
    ...
    "payBookingSubtitle": "Si ves un monedero arriba, úsalo; si no, paga con tarjeta abajo. Checkout seguro.",
...
IT_GUEST = {
    ...
    "payBookingSubtitle": "In alto usa il portafoglio se compare, altrimenti la carta qui sotto — pagamento sicuro.",
...
PL_GUEST = {
    ...
    "payBookingSubtitle": "Użyj portfela u góry, jeśli jest widoczny, albo zapłać kartą poniżej — bezpieczna płatność.",
