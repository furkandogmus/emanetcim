    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center">
      ...
      >
        ...
        <div className="flex flex-col gap-3">
          <h1 className="text-5xl font-black tracking-tighter text-gray-900 uppercase">{t("notFoundTitle")}</h1>
          <p className="text-base text-gray-400 font-medium px-4">{t("notFoundDescription")}</p>
        </div>
