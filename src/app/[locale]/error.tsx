    ...
    <div className="min-h-[80vh] flex flex-col items-center justify-center p-6 text-center">
      ...
      >
        ...
        <div className="flex flex-col gap-2">
           <h1 className="text-2xl font-black tracking-tight text-gray-900">Eyvah, bir sorun oldu!</h1>
           <p className="text-sm text-gray-500 leading-relaxed font-medium">Uygulamada teknik bir aksaklık yaşandı. Lütfen sayfayı yenilemeyi deneyin.</p>
        </div>
