...
export default async function AboutPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const values = [
    { title: t("value1Title"), desc: t("value1Desc"), icon: <MapPin size={32} /> },
    { title: t("value2Title"), desc: t("value2Desc"), icon: <ShieldCheck size={32} /> },
    ...
    <div className="min-h-screen bg-white font-sans overflow-hidden pt-32 pb-20">
      <div className="max-w-4xl mx-auto px-6">
        <header className="mb-20">
          ...
          <p className="text-xl font-bold text-gray-400 leading-relaxed max-w-xl">{t("intro")}</p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-32">
          <div className="p-10 bg-gray-50 rounded-[3rem] border border-gray-100 flex flex-col gap-4">
            ...
            <p className="font-bold text-gray-400 leading-relaxed">{t("visionBody")}</p>
          </div>
          <div className="p-10 bg-gray-900 text-white rounded-[3rem] flex flex-col gap-4 shadow-2xl shadow-gray-200">
            ...
            <p className="font-bold opacity-40 leading-relaxed">{t("missionBody")}</p>
          </div>
        </div>

        <div className="border-t border-gray-100 pt-20">
          <h3 className="text-sm font-black uppercase tracking-widest text-gray-400 mb-12 text-center">
            {t("whyUs")}
          </h3>
