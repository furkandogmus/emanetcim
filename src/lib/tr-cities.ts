 ...
 * Kaynak: TÜİK / Posta Kodu veritabanı (statik, güncel 2024).
 */
...
export const TR_CITIES: TrCity[] = [
  ...
  { name: "Bartın", districts: ["Arit","Kurucaşile","Merkez","Ulus"] },
  ...
  { name: "Çankırı", districts: ["Atkaracalar","Bayramören","Çerkeş","Eldivan","Ilgaz","Khanözü","Korgun","Kurşunlu","Merkez","Orta","Şabanözü","Yapraklı"] },
  ...
  { name: "Gaziantep", districts: ["Araban","İslahiye","Karkamış","Nurdağı","Oğuzeli","Şahinbey","Şehitkamil","Nizip","Yavuzeli"] },
  ...
  { name: "Kastamonu", districts: ["Abana","Ağlı","Araç","Azdavay","Bozkurt","Çatalzeytin","Daday","Devrekani","Doğanyurt","Hanönü","İhsangazi","İnebolu","Küre","Merkez","Pınarbaşı","Seydiler","Şenpazar","Taşköprü","Tosya"] },
  ...
  { name: "Trabzon", districts: ["Akçaabat","Araklı","Arsin","Beşikdüzü","Çarşıbaşı","Çaykara","Dernekpazarı","Düzköy","Hayrat","Köprübaşı","Maçka","Of","Ortahisar","Shalpazarı","Sürmene","Tonya","Vakfıkebir","Yomra"] },
  { name: "Tunceli", districts: ["Çemişgezek","Hozat","Mazgirt","Merkez","Nazimiye","Ovacık","Pertek","Pülümür"] },
  ...
  { name: "Yozgat", districts: ["Akdağmadeni","Aydıncık","Boğazlıyan","Çandır","Çayıralan","Çekerek","Kadışehri","Merkez","Saraykent","Sarıkaya","Şefaatli","Sorgun","Yenifakılı","Yerköy"] },
