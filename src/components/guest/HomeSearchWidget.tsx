  ...
  return (
    <div className="w-full max-w-2xl mx-auto bg-white border border-gray-200 shadow-xl rounded-2xl p-4 sm:p-6 flex flex-col sm:flex-row items-stretch sm:items-end gap-3">
      ...
      <button
        ...
        className="bg-orange-600 hover:bg-orange-700 text-white px-8 py-3 rounded-xl font-black text-sm transition-all shadow-lg shadow-orange-200 hover:shadow-orange-300 flex items-center justify-center gap-2 cursor-pointer whitespace-nowrap"
      >
        <Search size={18} />
        {t("findShops")}
      </button>
